...
void StoreTestValueRelativeAddress(InstructionExecutorTestFixture &fixture, const BCSRelative &instruction_param)
{
    fixture.fakeMemory[instruction_param.address.instruction_address + 1] = instruction_param.address.offset;
}

static void SetupAffectedOrUsedRegisters(InstructionExecutorTestFixture &fixture, const BCSRelative &instruction_param)
{
